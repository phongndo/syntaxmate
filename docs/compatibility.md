...
| Bundled experience | Grammars, themes, detection, HTML, and ANSI in one crate | Broad language/theme bundles and web integrations | Default syntax/theme sets plus Rust rendering helpers |
